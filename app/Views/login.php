...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url()?>/frontend/css/default.css">
...
<body>
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-xl-8 col-lg-8 col-md-7">
                        <div class="header-info">
                            <span class="header-address"><i class="fa fa-map-marker-alt"></i> 58 Howard Street #2 San
                                Francisco</span>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-md-5 d-flex align-items-center">
                        <div class="logo">
                            <a href="index.html"><img src="<?= base_url()?>/frontend/img/logo/logo.png" alt=""></a>
                        </div>
                    </div>
    ...
    <main>
        <!-- hero-area start -->
        <section class="breadcrumb-bg pt-200 pb-180" data-background="<?= base_url()?>/frontend/img/page/page-bg.jpg">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <div class="basic-login">
                            ...
                            <form action="<?= base_url('awal')?>">
                                ...
                                <button class="bt-btn bt-btn-sec w-100"  >Login Now</button>
                                <div class="or-divide"><span>or</span></div>
                                <button class="bt-btn w-100">Register Now</button>
                            </form>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-widget mb-30">
                            <div class="footer-logo mb-30">
                                <a href="#"><img src="<?= base_url()?>/frontend/img/logo/logo-light.png" alt=""></a>
                            </div>
                            ...
                            <div class="blog-feeds pr-15">
                                <div class="signle-blog-feeds mb-20">
                                    <div class="blog-feeds-thumb">
                                        <a href="blog-details.html"><img src="<?= base_url()?>/frontend/img/blog/feeds-thumb-1.jpg" alt=""></a>
                                    </div>
                                ...
                                <div class="signle-blog-feeds mb-20">
                                    <div class="blog-feeds-thumb">
                                        <a href="blog-details.html"><img src="<?= base_url()?>/frontend/img/blog/feeds-thumb-2.jpg" alt=""></a>
                                    </div>
                                    <div class="blog-feeds-text">
                                        <h5><a href="blog-details.html">Lorem ipsum dolor sit am et, consectetur.</a></h5>
                                        <span class="feeds-date">14 July 2019</span>
                                ...
                                <div class="signle-blog-feeds  mb-20">
                                    <div class="blog-feeds-thumb">
                                        <a href="blog-details.html"><img src="<?= base_url()?>/frontend/img/blog/feeds-thumb-3.jpg" alt=""></a>
                                    </div>
                                    <div class="blog-feeds-text">
                                        <h5><a href="blog-details.html">Lorem ipsum dolor sit am et, consectetur.</a></h5>
                                        <span class="feeds-date">14 July 2019</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 d-lg-block">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-instagram">
                                <ul>
                                    <li><a href="#"><img src="<?= base_url()?>/frontend/img/instagram/ins1.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url()?>/frontend/img/instagram/ins2.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url()?>/frontend/img/instagram/ins3.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url()?>/frontend/img/instagram/ins4.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url()?>/frontend/img/instagram/ins5.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="<?= base_url()?>/frontend/img/instagram/ins6.jpg" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
