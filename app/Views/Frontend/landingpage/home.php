...
<head>
    ...
    <title>Beakai - Business and Financial Institution HTML5 Template </title>
...
<body>
                ...
                <div class="row d-flex align-items-center">
                    <div class="col-xl-8 col-lg-8 col-md-7">
                        <div class="header-info">
                            <span class="header-address"><i class="fa fa-map-marker-alt"></i> 58 Howard Street #2 San Francisco</span>
                            <span  class="header-phone"><i class="fas fa-phone"></i> +1 800 833 9780</span>
                            <span  class="header-email"><i class="fas fa-envelope"></i> info@example.com</span>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-9">
                        <div class="header-right f-right d-none d-lg-block">
                            <a href="appoinment.html" class="bt-btn btn-h-white">Get a Quote</a>
                        </div>
                        <div class="header__menu f-right">
                            <nav id="mobile-menu">
                                <ul>
                                    <li class="menu-item-has-children"><a href="frontend/index.html">Home</a>
                                        <ul class="submenu">
                                    ...
                                    <li class="menu-item-has-children"><a href="frontend/services.html">Services</a>
                                        <ul class="submenu">
                                    ...
                                    <li class="menu-item-has-children"><a href="frontend/team.html">Team</a>
                                        <ul class="submenu">
                                    ...
                                    <li class="menu-item-has-children"><a href="frontend/shop.html">Shop</a>
                                        <ul class="submenu">
                                            <li><a href="frontend/shop.html">Shop Page</a></li>
                                            <li><a href="frontend/product-details.html">Shop Details</a></li>
                                    ...
                                    <li class="menu-item-has-children"><a href="frontend/blog.html">Blog</a>
                                        <ul class="submenu">
    ...
    <main>
        ...
        <section class="hero-area">
            <div class="hero-slider">
                <div class="slider-active">
                    <div class="single-slider slider-height d-flex align-items-center" data-background="frontend/img/slider/01.jpg">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-8 col-md-10">
                                    <div class="hero-text">
                                        <div class="hero-slider-caption ">
                                            <h5 data-animation="fadeInUp" data-delay=".2s">We are here for your help.</h5>
                                            <h1 data-animation="fadeInUp" data-delay=".4s">Finance Advice & Gloabl Solution.</h1>
                                        ...
                                        <div class="hero-slider-btn">
                                            <a data-animation="fadeInLeft" data-delay=".6s" href="frontend/about.html" class="bt-btn btn-h-white">Discover More</a>
                    ...
                    <div class="single-slider slider-height d-flex align-items-center" data-background="frontend/img/slider/02.jpg">
                        <div class="container">
                            <div class="row">
                                <div class="col-xl-7 col-lg-8 col-md-10">
                                    <div class="hero-text">
                                        ...
                                        <div class="hero-slider-btn">
                                            <a data-animation="fadeInLeft" data-delay=".6s" href="frontend/about.html" class="bt-btn btn-h-white">About Us</a>
                        ...
                        <div class="about-left-side pos-rel mb-30">
                            ...
                            <div class="about-exp">
                                ...
                                <div class="exp-content">
                                    <h2 class="exp-title"><span class="counter">25</span> +</h2>
                    ...
                    <div class="col-xl-6 col-lg-7">
                        <div class="about-right-side pt-30 mb-30">
                            <div class="about-title mb-20">
                                <h5>About Us</h5>
                                <h1>Trusted by more than 2768 clients.</h1>
                            </div>
                            <div class="about-text">
                                <p class="about-quote">Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="service-box text-center mb-30">
                            <div class="service-thumb">
                                <i class="flaticon-business-and-finance-1"></i>
                            </div>
                            <div class="service-content">
                                <h3><a href="services-details.html">Planning & Conducting</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
                                <a class="service-link" href="services-details.html">Read More <i class="fas fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="service-box text-center mb-30">
                            ...
                            <div class="service-content">
                                <h3><a href="frontend/services-details.html">Financial Opportunities</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
                                <a class="service-link" href="frontend/services-details.html">Read More <i class="fas fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="service-box text-center mb-30">
                            <div class="service-thumb">
                                <i class="flaticon-team-work-1"></i>
                            </div>
                            <div class="service-content">
                                <h3><a href="frontend/services-details.html">Business Forecast</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
                                <a class="service-link" href="frontend/services-details.html">Read More <i class="fas fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="service-box text-center mb-30">
                            <div class="service-thumb">
                                <i class="flaticon-business-and-finance-12"></i>
                            </div>
                            <div class="service-content">
                                <h3><a href="frontend/services-details.html">Financial Consultation</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
                                <a class="service-link" href="services-details.html">Read More <i class="fas fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="service-box text-center mb-30">
                            ...
                            <div class="service-content">
                                <h3><a href="frontend/services-details.html">Technology Advising</a></h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore.</p>
                                <a class="service-link" href="services-details.html">Read More <i class="fas fa-angle-double-right"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-xl-10 offset-xl-1 col-md-12">
                        <div class="cta-text text-center">
                            ...
                            <div class="section-button section-button-left">
                                <a href="frontend/appoinment.html" class="bt-btn">Meet With Us</a>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <section class="news-letter-area pt-120 pb-120" data-background="frontend/img/newsletter/news-letter-bg.jpg">
            <div class="container">
                <div class="row">
        ...
        <!-- pricing area start -->
        <section class="pricing-area gray-bg pt-120 pb-120 bg-2">
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8 col-lg-10 ">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                        <div class="single-pricing-box">
                            ...
                            <div class="pricing-list mb-40">
                                <ul>
                                    <li>IT Solutions<i class="fal fa-check"></i></li>
                                    <li>Software Development<i class="fal fa-check"></i></li>
                                    <li>UX/UI Strategy<i class="fal fa-check"></i></li>
                                    <li>IT Consulting<i class="fal fa-check"></i></li>
                                    <li>Designing Step <i class="fal fa-check"></i></li>
                                </ul>
                            </div>
                            <a href="frontend/contact.html" class="bt-btn transparent">Make Payment</a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                        <div class="single-pricing-box active bg_img" data-overlay="94"
                            ...
                            <div class="pricing-list mb-40">
                                <ul>
                                    ...
                                    <li>IT Consulting<i class="fal fa-check"></i></li>
                                    <li>Designing Step <i class="fal fa-check"></i></li>
                                    <li>Product Design <i class="fal fa-check"></i></li>
                                </ul>
                            </div>
                            <a href="contact.html" class="bt-btn transparent">Make Payment</a>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 mt-30">
                        <div class="single-pricing-box">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6">
                        <div class="latest-news-box mb-30">
                            ...
                            <div class="latest-news-content">
                                ...
                                <h3><a href="blog-details.html">Lorem ipsum dolor sit amet, cons ectetur adidis dicolo wiran.</a></h3>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6">
                        <div class="footer-widget mb-30">
                            <div class="footer-logo mb-30">
                                <a href="#"><img src="frontend/img/logo/logo-light.png" alt=""></a>
                            </div>
                        ...
                        <div class="footer-widget mb-30 pl-20">
                            ...
                            <div class="footer-menu-2">
                                <ul>
                                    ...
                                    <li><a href="frontend/contact.html">FAQ</a></li>
                                    <li><a href="frontend/contact.html">Contact us</a></li>
                                    <li><a href="frontend/contact.html">Locations</a></li>
                                    <li><a href="frontend/blog.html">Caregivers</a></li>
                                    <li><a href="frontend/blog.html">New & Blog</a></li>
                                    <li><a href="frontend/portfolio.html">Gallery</a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="blog-feeds pr-15">
                                <div class="signle-blog-feeds mb-20">
                                    <div class="blog-feeds-thumb">
                                        <a href="blog-details.html"><img src="frontend/img/blog/feeds-thumb-1.jpg" alt=""></a>
                                    </div>
                                ...
                                <div class="signle-blog-feeds mb-20">
                                    <div class="blog-feeds-thumb">
                                        <a href="blog-details.html"><img src="frontend/img/blog/feeds-thumb-2.jpg" alt=""></a>
                                    </div>
                                    <div class="blog-feeds-text">
                                        <h5><a href="blog-details.html">Lorem ipsum dolor sit am et, consectetur.</a></h5>
                                        <span class="feeds-date">14 July 2019</span>
                                ...
                                <div class="signle-blog-feeds  mb-20">
                                    <div class="blog-feeds-thumb">
                                        <a href="blog-details.html"><img src="frontend/img/blog/feeds-thumb-3.jpg" alt=""></a>
                                    </div>
                                    <div class="blog-feeds-text">
                                        <h5><a href="blog-details.html">Lorem ipsum dolor sit am et, consectetur.</a></h5>
                                        <span class="feeds-date">14 July 2019</span>
                    ...
                    <div class="col-xl-3 col-lg-4 col-md-6 d-lg-block">
                        <div class="footer-widget mb-30">
                            ...
                            <div class="footer-instagram">
                                <ul>
                                    <li><a href="#"><img src="frontend/img/instagram/ins2.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="frontend/img/instagram/ins3.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="frontend/img/instagram/ins1.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="frontend/img/instagram/ins4.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="frontend/img/instagram/ins5.jpg" alt=""></a></li>
                                    <li><a href="#"><img src="frontend/img/instagram/ins6.jpg" alt=""></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
