                ...
                <div class="blog-post">
                    <div class="single-blog-post">
                        ...
                        <div class="text-holder">
                            ...
                            <h3 class="blog-title">Essential advice on choosing a top class consultant</h3> 
                            <div class="text">
                                <p class="mar-bottom">Explain to you how all this mistaken idea of denouncing pleasure and praising pain was born and  will give you a complete account of the system, and seds expound the actual teachings of the great explorer of the truth, the master-builder of human happiness. </p>
                                <p>Who loves or pursues or desires to obtain pain of itself, because it is pain, but because occasionally circumstances occur in which toil and pain can procure him some great pleasure. To take a trivial example, except obtain some advantage from it right to find fault.</p>
                            </div>
                            ...
                            <div class="middle-content-box">
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="img-holder">
                                            <img src="frontend/images/blog/caption-img.jpg" alt="Awesome Image">
                                        </div>
                                        <div class="text-box">
                                            <p>They have got my project on time with competition seds with a highly skilled, well-organized and denouncing of pleasures.</p>
                                            <h3>Dohn Gaskel</h3>
                                            <h5>Manager</h5>
                                        </div>
                                    </div>
                        ...
                        <ul class="popular-post">
                            <li>
                                ...
                                <div class="title-holder">
                                    ...
                                    <h6 class="post-date">October 21, 2017</h6>
                                </div>
                            </li>
                            <li>
                                <div class="img-holder">
                                ...
                                <div class="title-holder">
                                    ...
                                    <h6 class="post-date">August 14, 2017</h6>
                                </div>
                            </li>
                            <li>
                                <div class="img-holder">
                                ...
                                <div class="title-holder">
                                    <a href="#"><h5 class="post-title">Tips for sucess in 2017:<br>reach your goal</h5></a>
                                    <h6 class="post-date">February 17, 2017</h6>
                                </div>
                            </li>
                        </ul>
                    </div>
