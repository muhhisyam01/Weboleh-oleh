                            ...
                            <nav class="main-menu clearfix">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="dropdown current"><a href="Shop">Shop</a>
                                            <ul>
        ...
        <div class="row">
            <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 float-right">
                <div class="shop-content">
                    ...
                    <?php foreach ($produk as $get_produk) { ?>
                                ...
                                <div class="title-holder">
                                    ...
                                    <div class="bottom">
                                        <div class="cart-button pull-left">
                                            <a href="<?= base_url('ShopDetail'.$get_produk['id_produk']) ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i> Detail</a>
                                        </div>
                ...
                <div class="sidebar-wrapper">
                    ...
                    <!-- <div class="single-sidebar">
                        ...
                        <ul class="latest-product">
                            <li>
                                <div class="img-holder">
                                    <img src="frontend/images/shop/product-thumb-1.jpg" alt="Awesome Image">
                                    <div class="overlay-style-one">
                                        <div class="box">
                                            <div class="content">
                            ...
                            <li>
                                <div class="img-holder">
                                    <img src="frontend/images/shop/product-thumb-2.jpg" alt="Awesome Image">
                                    <div class="overlay-style-one">
                                        <div class="box">
                                            <div class="content">
                                                <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
                            ...
                            <li>
                                <div class="img-holder">
                                    <img src="frontend/images/shop/product-thumb-3.jpg" alt="Awesome Image">
                                    <div class="overlay-style-one">
                                        <div class="box">
                                            <div class="content">
                                                <a href="#"><i class="fa fa-link" aria-hidden="true"></i></a>
