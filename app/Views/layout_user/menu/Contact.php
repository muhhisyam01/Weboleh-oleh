            ...
            <div class="col-xl-4 col-lg-5 col-md-6 col-sm-12">
                <div class="contact-author-info contact-info">
                    <div class="img-holder">
                        <img src="frontend/images/resources/contact-img.jpg" alt="Awesome Image">
                    </div>
                    <div class="contact-carousel owl-nav-style-one">
                            ...
                            <ul>
                                <li>
                                    ...
                                    <div class="text-holder">
                                        <p><span>Address:</span> inFocus, 2nd Breaking<br>Str, Newyork ,USA 10002.</p>
                                    </div>
                                </li>
                                <li>
                                    <div class="icon-holder">
                                ...
                                <li>
                                    ...
                                    <div class="text-holder">
                                        <p><span>Mail Us:</span><br> Supportyou@inFocusteam.com</p>
                                    </div>
                                </li>
                            </ul>
